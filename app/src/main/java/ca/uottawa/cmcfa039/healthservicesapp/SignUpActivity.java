...
*/
        ...
        if (patientBox.isChecked()) {
            signupPatient(email, password, firstName, lastName);
        }
        else {
            signupEmployee(email, password, firstName, lastName);
        }

    }

    public void signupPatient(String email, String password, String firstName, String lastName) {
    ...
    public void signupEmployee(String email, String password, String firstName, String lastName) {
